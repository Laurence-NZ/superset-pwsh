...
The scripts auto-detect your platform (macOS on Apple Silicon or Intel, Linux on
x64 or arm64, or Windows x64), install Superset under `~/superset` by default, and add
